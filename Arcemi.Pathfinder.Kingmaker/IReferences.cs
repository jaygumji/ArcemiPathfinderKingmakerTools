...
namespace Arcemi.Pathfinder.Kingmaker
{
    public interface IReferences
    {
        ...
        ListAccessor<T> GetOrCreateList<T>(JObject parent, string name, Func<ModelDataAccessor, T> factory = null);
        ListValueAccessor<T> GetOrCreateListValue<T>(JObject parent, string name);
