...
namespace Arcemi.Models.Warhammer40KRogueTrader
{
    public class W40KRTBlueprintTypeProvider : IBlueprintTypeProvider
    {
        ...
        public static BlueprintType Item { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.BlueprintItem, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemArmor { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Armors.BlueprintItemArmor, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemArmorPlating { get; } = new BlueprintType("", "Warhammer.SpaceCombat.Blueprints.BlueprintItemArmorPlating, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemAugerArray { get; } = new BlueprintType("", "Warhammer.SpaceCombat.Blueprints.BlueprintItemAugerArray, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemEquipmentFeet { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentFeet, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemEquipmentGloves { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentGloves, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemEquipmentHead { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentHead, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemEquipmentNeck { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentNeck, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemEquipmentRing { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentRing, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemEquipmentShoulders { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentShoulders, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemEquipmentUsable { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentUsable, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemKey { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.BlueprintItemKey, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemLifeSustainer { get; } = new BlueprintType("", "Warhammer.SpaceCombat.Blueprints.BlueprintItemLifeSustainer, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemMechadendrite { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Equipment.BlueprintItemMechadendrite, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemNote { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.BlueprintItemNote, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemPlasmaDrives { get; } = new BlueprintType("", "Warhammer.SpaceCombat.Blueprints.BlueprintItemPlasmaDrives, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemResourceMiner { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.BlueprintItemResourceMiner, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemsList { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.BlueprintItemsList, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemsStash { get; } = new BlueprintType("", "Kingmaker.Blueprints.BlueprintItemsStash, RogueTrader.GameCore, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemVoidShieldGenerator { get; } = new BlueprintType("", "Warhammer.SpaceCombat.Blueprints.BlueprintItemVoidShieldGenerator, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        public static BlueprintType ItemWeapon { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.Weapons.BlueprintItemWeapon, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
        ...
        public static BlueprintType Loot { get; } = new BlueprintType("", "Kingmaker.Blueprints.Loot.BlueprintLoot, Code, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
