...
namespace Arcemi.Models.PathfinderWotr
{
    public class WotrBlueprintTypeProvider : IBlueprintTypeProvider
    {
        ...
        public static BlueprintType HiddenItem { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.BlueprintHiddenItem");
        ...
        public static BlueprintType Ingredient { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Craft.BlueprintIngredient");
        ...
        public static BlueprintType Item { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.BlueprintItem");
        public static BlueprintType ItemArmor { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Armors.BlueprintItemArmor");
        public static BlueprintType ItemEquipmentBelt { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentBelt");
        public static BlueprintType ItemEquipmentFeet { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentFeet");
        public static BlueprintType ItemEquipmentGlasses { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentGlasses");
        public static BlueprintType ItemEquipmentGloves { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentGloves");
        public static BlueprintType ItemEquipmentHead { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentHead");
        public static BlueprintType ItemEquipmentNeck { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentNeck");
        public static BlueprintType ItemEquipmentRing { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentRing");
        public static BlueprintType ItemEquipmentShirt { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentShirt");
        public static BlueprintType ItemEquipmentShoulders { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentShoulders");
        public static BlueprintType ItemEquipmentUsable { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentUsable");
        public static BlueprintType ItemEquipmentWrist { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Equipment.BlueprintItemEquipmentWrist");
        public static BlueprintType ItemKey { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.BlueprintItemKey");
        public static BlueprintType ItemNote { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.BlueprintItemNote");
        public static BlueprintType ItemShield { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Shields.BlueprintItemShield");
        public static BlueprintType ItemsList { get; } = new BlueprintType("", "Kingmaker.Blueprints.Items.BlueprintItemsList");
        public static BlueprintType ItemThiefTool { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.BlueprintItemThiefTool");
        public static BlueprintType ItemWeapon { get; } = new BlueprintType("", BlueprintTypeCategory.Item, "Kingmaker.Blueprints.Items.Weapons.BlueprintItemWeapon");
